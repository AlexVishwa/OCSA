...
<div class="modal_popup">
	<div class="modal_inner">
		 ...
		 <div class="header">
		 	...
		 	<h3 style="font-size: 18px;"><img src="<?php echo $book['img']; ?>" style="width: 25px;margin-right: 10px;"><?php echo $book['title']; ?>
          ...
          <div class="card">
				    ...
				    <div id="collapse<?php echo $sub;?>" class="collapse " data-parent="#accordion" data-aos="flip-left">
				      <div class="card-body">
				          <!-- radio button -->
				          <?php 
				          for ($op=0; $op <count($book['options'][$sub]['type']) ; $op++) { 
				          	 ?>
				             <div id="pricing" data-pricing="<?php echo $book['options'][$sub]['type'][$op]['price']; ?>" data-title="<?php echo $book['options'][$sub]['type'][$op]['item']; ?>" data-type="<?php echo $book['options'][$sub]['service_type'];?>">
				             	 <p><?php echo $book['options'][$sub]['type'][$op]['item']; ?> 
                                 <?php echo @$book['options'][$sub]['type'][$op]['desc']; ?></p>
				             	 <p> &#8377; <?php echo $book['options'][$sub]['type'][$op]['price']; ?></p>
				             </div>
				             <p>
				             	<?php echo @$book['options'][$sub]['type'][$op]['note']; ?>
				             </p>
						    <?php
							}
							echo'<hr>'. @$book['options'][$sub]['description'];
						    ?>
...
<div class="container-fluid" style="background:linear-gradient(45deg, white, #bdb7b794),url(images/services-background.jpg);">
	<h2 style="text-align: center;background: #aa0000;color: #fff;padding: 6px;margin-top: 64px;border-radius: 30px;">Book Service</h2>
	<hr>
...
<form action="book_service.php" method="post" id="bookservice_form">
	...
	<div class="input-field col-md-6 col-sm-12">
          ...
          <input name="servicename" type="text" value="<?php echo $book['title']; ?>" readonly class="form-control">
