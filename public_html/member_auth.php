...
$sql="select * from member where mobile='$_POST[mobile]' and password='$_POST[pwd]';";
$tog=0;
...
if(mysqli_num_rows($arr) != 0)
{
        ...
        $profile='';
        $sql2="select * from member where mobile='$_POST[mobile]' and password='$_POST[pwd]' and active=1;";
