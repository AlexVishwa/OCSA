...
<div class="container-fluid" style="display: flex;flex-direction: column;justify-content: center;align-items: center;padding: 20px 0px;background: #ffffffab;">
	<h2 style="border-bottom: 1px solid;padding-bottom: 5px;color: #aa0000;font-weight: bold;">Shopkeeper Login</h2>

	<form id="shop_auth" method="post" style="width: 300px;padding: 30px 5px;">
	  ...
	  <button type="submit" class="btn btn-primary" id="slogin" style="background: #aa0000;color: #fff !important;">LOGIN</button><br>
	...
	<p style="font-size: 18px">Don't have an account 
		<a href="shopkeeper-reg.php" style="background: #29d650;color: white;padding: 2px 10px;   border-radius: 0px;">Register Now</a></p>
</div>
<?php
