...
?>
<style type="text/css">
	.container-fluid.privacy span {
    font-weight: bold;
    padding-left: 7px;
}
.container-fluid.privacy b {
    background: #aa0000;
    padding: 3px 10px;
    color: #fff;
}
.container-fluid.privacy p {
    background: #fff;
    padding: 6px 10px;
...
<div class="container-fluid privacy">
	<h3 style="background: linear-gradient(45deg, #aa0000, #b3d7ff);padding: 12px;margin: 65px 0px 12px 0px;box-shadow: 1px 1px 10px #00000078;border-radius: 44px;font-size: 20px;font-weight: bold;color: #fff;text-align: center;">Privacy Policy (IND)</h3>
	<p>Our management has developed this Privacy Statement(Policy) to express our firm commitment to aid our users better understand what information we collect about them and what may happen to that information.</p>


<p>This Privacy Policy agreement is effective as of:  September  05th , 2019
OCSA Private LimitedLtd ("OCSA") values your privacy. In this Privacy Policy ("Policy"), we describe the information that we collect about you when you visit our website, www.Ocsa.in (the "Website") and use the services available on the Website ("Services"), and how we use and disclose that information.<br>
If you have any questions or comments about the Privacy Policy, please contact us at support@ocsa.in . This Policy is incorporated into and is subject to the OCSA Terms of Use, which can be accessed at www.ocsa.in/terms . Your use of the Website and/or Services and any personal information you provide on the Website remains subject to the terms of the Policy and OCSA's Terms of Use.
In terms of the Information Technology (Intermediaries Guidelines) Rules, 2011 and the Information Technology (Reasonable Security Practices and Procedures and Sensitive Personal Data or Information) Rules, 2011, any grievance or complaint may be intimated to Amit Bhatnagar, Grievance Officer, who may be reached at Duplex A-71, Green Paradise, A To Z Colony, Modipuram,Meerut-250110 (Uttar-Pradesh) India. The complaint shall be redressed within a period of 1 (one) month.</p>
<b>A. Collection of Your Personal Information</b><br>
<span>1. COLLECTION OF PERSONAL INFORMATION</span>
...
<p>
We collect personal information from Service Professionals offering their products and services. This information is partially or completely accessible to all visitors using OCSA’s website or mobile application, either directly or by submitting a request for a service. Service Professionals and customers are required to create an account to be able to access certain portions of our Website, such as to submit questions, participate in polls or surveys, to request a quote, to submit a bid in response to a quote, and request information. - Service Professionals, if and when they create and use an account with OCSA, will be required to disclose and provide to OCSA information including personal contact details, bank details, personal identification details (such as PAN card, Aadhar card, phonebook, call logs etc.) and participate in polls or surveys or feedbacks etc. Such information gathered shall be utilized to ensure greater customer satisfaction and help a customer satiate their needs. The type of personal information that we collect from you varies based on your particular interaction with our Website or mobile application.
</p>
<p>
Consumers: During the Account registration Rs 100 /-. process & To activate the service, the customer has to deposit Rs.3600 / - in his security wallet. To activate the service, the customer has to deposit Rs. 3600 / - in his security wallet. After one year, the security deposit can be withdrawn from the security wallet. The customer will be eligible to transfer their security wallets from the security wallets to their security wallet on completion of one year. MRP will get 10 to 20% off on spare parts for all equipment in authorized shops, auto workshops, beauty parlors, restaurants and other OCSA.Customer's centers. Customers can avail various offers by shopping with OCSA Wallet. Customers can avail various attractive cash by scanning and paying QR codes. Pay with wallet, you have to give a request before 48 or 72 hours that the amount be deposited in the customer's bank account. and during your usage of OCSA’s website or application, we will collect information such as your name, postal code, telephone email address and other personal information. You also may provide us with your, mailing address, and demographic information (e.g., gender, age, political preference, education, race or ethnic origin, and other information relevant to user surveys and/or offers). We may also collect personal information that you post in your Offer, Profile, Wants, or Feedback, and any comments or discussions you post in any blog, chat room, or other correspondence site on the Website or mobile application, or any comments you provide during dispute resolution with other users of the Website or mobile application.
</p>
<p>
Service Professionals: If you are a Service Professional and would like to post any information about yourself, we will require you to register for an Account. During the Account registration process, we will collect your business name, telephone number, address, zip code, travel preferences, a description of your services, a headline for your profile, first and last name, and email address. Other information may also be required to be provided to OCSA whilst you avail and use OCSA’s website or application. In addition, you may, but are not required to, provide other content or information about your business, including photographs and videos. We also may collect payment information, such as credit card information, from you.
</p>
<p>
Background Verification: The Service Professional acknowledges that as part of the on-boarding process, the Company or an entity /agency appointed or nominated by the Company (“Verifier”), may undertake background verification checks of the Service Professional in order to authenticate inter alia the genuineness and competency of the Service Professional. In light of the above, the Service Professional expressly consents to and acknowledges the following:
</p>
<p>
	
i) The Service Professional does not and will not have any objection to OCSA sharing the Service Professional’s personal information and documents, including but not limited to name, gender, date of birth, addresses, mobile number, email, education record, employment record, Aadhaar number, other government issued IDs such as Voter ID, PAN card, driving license etc. (collectively “Proprietary Information”) with the Verifier for the purpose of background checks and verification.
<br>
ii) The Service Professional authorizes the Verifier to securely store the Service Professional’s Proprietary Information on their platform and understands that the Verifier shall endeavour to ensure confidentiality of the same.
<br>
iii) The Service Professional acknowledges that the digital record of the Proprietary Information on the Verifier’s platform shall be accessible to OCSA and OCSA and their authorized users/partners/affiliates/contractors shall be entitled to access and update such digital record on the Verifier’s platform, including data, documents, certificates, verification reports, references, testimonials, etc. and shall be entitled to use the related services provided via the Verifier’s platform.
<br>

iv) The Service Professional acknowledges that if the Service Professional is desirous of editing and/or deleting its digital record from the Verifier’s platform, it shall be entitled to do so by sending an email to such email address of the Verifier which shall be immediately provided by the Company to the Service Professional, and in such a manner as the Verifier requires the same.
<br>
v) OCSA reserves its right to take appropriate actions (in its sole discretion) pursuant to the outcome of the background check and verification.
OCSA reserves the right to record the conversations between service professionals and consumers facilitated by OCSA through the messaging/chat mechanism on the platform or the calls made through the virtual numbers provided to safeguard the privacy of consumers and service professionals. All the chat/messaging logs or call recordings can be used to but not limited to monitor and prohibit abuse, safeguard the rights of consumers and service professionals, resolve disputes.
...
<span>4. THIRD PARTY DATA POLICY</span>
<p>
	
		a. This app contains a software development kit (“SDK”) from a third party, Red Brick Lane Marketing Solutions Private Limited (“RBL”). The SDK is integrated with this app for the purposes of profiling the device on media consumption and other device data and utilizing the same to analyse media behaviour and/or target relevant content and ads to the device (“Services”) pursuant to the terms and conditions of RBL Services (“Terms of Use”). Further details can be obtained at http://www.zapr.in/privacy/
	    <br>
		b. If you do not wish for RBL to identify television, radio and other offline content viewing around your mobile device, please opt out of all RBL Services via the following link: http://www.zapr.in/privacy/
	    <br>
		c. RBL does not collect any personally identifiable information or audio/video / image/contact files from your mobile device. For any questions or clarifications please reach out to: privacy@zapr.in
	    <br>
		d. RBL also automatically receives and tracks certain data about your mobile device (such as your device-type, installed software and language preference) your taps and interests; and may create a unique device or user ID for you. In some cases RBL can automatically detect or infer your location using GPS, your IP address, watermarks, but often your operating system will require you to grant RBL permission to access your GPS; please refer to your device’s system settings regarding location services
	
</p>



<b>B. How OCSA Uses the Information We Collect</b><br>
<span>1. HOW PERSONAL INFORMATION IS USED</span>
<p>
...
To provide our Services to you, including registering you for our Services, verifying your identity and authority to use our Services, and to otherwise enable you to use our Website and our Services;<br>
For customer support and to respond to your inquiries;<br>
For internal record-keeping purposes;<br>
To process billing and payment, including sharing with third party payment gateways in connection with Website and/or OCSA's products and Services;<br>
To improve and maintain our Website and our Services (for example, we track information entered through the "Search" function; this helps us determine which areas of our Website users like best and areas that we may want to enhance; we also will use for trouble-shooting purposes, where applicable);<br>
To periodically send promotional emails to the email address you provide regarding new products from OCSA, special offers from OCSA or other information about OCSA that we think you may find interesting;<br>
To contact you via email, telephone, facsimile or mail, or, where requested, by text message, to deliver certain services or information you have requested;<br>
For OCSA's market research purposes, including, but not limited to, the customization of the Website according to your interests;
...
We also may compare personal information collected through the Website and Services to verify its accuracy with personal information collected from third parties; and<br>
We may combine aggregate data with the personal information we collect about you.
From time to time, OCSA may use personal information for new and unanticipated uses not previously disclosed in our Privacy Policy. If our information practices change regarding information previously collected, OCSA shall make reasonable efforts to provide notice and obtain consent of any such uses as may be required by law.<br>
</p>


<b>C. Electronic Newsletters, Invitations, Polls and Surveys</b>
<p><br>
At our sole discretion, OCSA may offer any of the following free services on the Website, which you may select to use or receive at your option. Certain of the following services may require you to provide additional personal information as detailed below:</p>
<span>1. ELECTRONIC NEWSLETTERS</span>
<p>
We may offer a free electronic newsletter to users. We will gather the email addresses of users who sign up for OCSA for the newsletter mailing list. Users may remove themselves from this mailing list by opting out of receiving newsletters during the registration process, by following the link provided in each newsletter that points users to a subscription management page where the user can unsubscribe from receiving newsletters or by changing their preferences in their Profile Settings page.</p>

<span>2. "SEND TO A FRIEND"</span>
<p>
...
<span>4. DISCLOSURE TO OTHER USERS OF OUR WEBSITE</span>
<p>
...
<span>5. INFORMATION DISCLOSED TO LAW ENFORCEMENT OR GOVERNMENT OFFICIALS</span>
<p>
...
<span>6. IN THE EVENT OF A CHANGE OF CONTROL OR BANKRUPTCY</span>
<p>
In the event that OCSA undergoes a change in control, including, without limitation, a merger or sale of all or substantially all of OCSA's assets to which this Website relates or other corporate reorganization in which OCSA participates, and is thus merged with or acquired by a third party entity (a "Successor"), OCSA hereby reserves the right to transfer the information we have collected from the users of the Website and/or Services to such Successor.<br>
In addition, in the event of OCSA's bankruptcy, reorganization, receivership, or assignment for the benefit of creditors, or the application or laws or equitable principles affecting creditors' rights generally, OCSA may not be able to control how your information is transferred, used, or treated and reserves the right to transfer the information we have collected from the users of the Website and/or Services to non-affiliated third parties in such event.
</p>

<span>7. INFORMATION DISCLOSED AT YOUR REQUEST</span>

<p>We may share your personal information with other Registered Users to whom you explicitly ask us to send your information or if you explicitly consent to such disclosure upon receipt of a specific Service. For instance, when you contract for a specific Service with another Registered User, OCSA will send that Registered User a notice that includes the personal information that you have chosen to allow OCSA to reveal to users with whom you contract.</p>

<b>F. LINKS OF EXTERNAL WEBSITES</b>
<p><br>
The Website may contain links to other websites or resources over which OCSA does not have any control. Such links do not constitute an endorsement by OCSA of those external websites. You acknowledge that OCSA is providing these links to you only as a convenience, and further agree that OCSA is not responsible for the content of such external websites. We are not responsible for the protection and privacy of any information which you provide while visiting such external websites and such sites are not governed by this Policy. Your use of any external website is subject to the terms of use and privacy policy located on the linked to external website.
</p>

<b>G. Updating, Deleting and Correcting Your Personal Information</b>
<p><br>
You may choose to restrict the collection or use of your personal information in the following ways:
You can review, correct and delete your personal information by logging into the Website and navigating to your preferences page in "Edit Profile." You must promptly update your personal information if it changes or is inaccurate. Typically, we will not manually alter your personal information because it is very difficult to verify your identity remotely. Nonetheless, upon your request we will close your Account and remove your personal information from view as soon as reasonably possible based on your Account activity and in accordance with applicable law. We do retain information from closed Accounts in order to comply with the law, prevent fraud, collect any fees owed, resolve disputes, troubleshoot problems, assist with any investigations of any Registered User, enforce our Terms of Use, and take any other actions otherwise permitted by law that we deem necessary in our sole and absolute discretion. You should understand, however, that once you publicly post a Request, Offer, Want, Feedback, or any other information onto the Website, you may not be able to change or remove it. Once we have deleted or removed your Account, you agree that OCSA shall not be responsible for any personal information that was not included within your deleted and/or removed Account that remains on the Website.
</p>

<b>H. What Choices Do I Have Regarding Use of My Personal Information?</b>
<p><br>
